...
import com.example.evaluation_2.databinding.FragmentGenderBinding;
import com.example.evaluation_2.databinding.FragmentWeightBinding;
...
public class WeightFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.submitButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.submitWeight();
            }
        });

    }

    WeightFragment.weightListener mListener;

    @Override
    public void onAttach(@NonNull Context context) {
        super.onAttach(context);
        mListener = (WeightFragment.weightListener) context;
    }
